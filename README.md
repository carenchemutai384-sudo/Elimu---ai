...
|---|---|
| ![Homepage](screenshot-home.png) | ![Answer](screenshot-answer.png) |
...
This project was built to make quality educational support more accessible to KCSE students by combining artificial intelligence with an easy-to-use interface.
