...
🔗 Live demo: carenchemutai384-sudo.github.io/Elimu---ai/
The live demo requires your own free Gemini API key (get one at aistudio.google.com). Your key is stored only in your browser and is never sent anywhere except Google's API — it is never saved to GitHub.
Demo
�
Load image
...
Launch index.html in your browser and paste your API key into the field provided.
Future Improvements
